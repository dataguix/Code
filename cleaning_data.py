# -*- coding: utf-8 -*-
"""
Created on Thu Aug 23 12:08:49 2018
...
df = pd.read_csv(r'C:\Users\Asus\Desktop\webscrap\US\projet nasdaq\panel_nyse_text_brut_avant2001.csv',engine='python')
...
for i in range(len(df)):
    print(float(i)/float(len(df))*100)
    df['Text'][i] = from_string_to_token(df['Text'][i])
      

df.to_csv('E:/projet nasdaq/nyse_stem_avant2001.csv')
